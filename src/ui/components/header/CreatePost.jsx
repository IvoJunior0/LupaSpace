...
export default function CreatePost({active}) {
    ...
    return(
        <div className={`top-0 left-0 flex justify-center backdrop-brightness-50 backdrop-blur-[1.5px] w-full h-full ${close ? 'fixed' : 'hidden'}`}>
            <div className="flex flex-col gap-5 w-[100%] h-[480px] p-8 max-w-3xl mx-4 bg-slate-50 text-gray-500 self-center rounded-xl border-4 border-gray-300 shadow-lg">
                <div className="flex justify-between">
                    ...
                    <button onClick={closeWindow}><FontAwesomeIcon icon={faXmark} className="text-2xl"/></button>
                </div>
                <div>
