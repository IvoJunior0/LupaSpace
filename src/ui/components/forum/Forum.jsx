...
const forumStylesMap = {
    ...
    networks: { backgroundColor: 'bg-cyan-400', icon: faWifi },
...
export default function Forum({ props }) {
    ...
    return(
        <div className="p-5 grid grid-cols-[120px_1fr_120px_120px_120px] grid-rows-[50px_50px] gap-4 text-gray-500 rounded-md bg-slate-100 border-4 hover:border-slate-300">
            <div className={`rounded-md row-span-2 flex justify-center items-center ${forumStyles.backgroundColor}`}>
                <FontAwesomeIcon icon={forumStyles.icon} className="text-white text-7xl"/>
            </div>
